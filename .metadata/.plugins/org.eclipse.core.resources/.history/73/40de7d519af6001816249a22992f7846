...
public class Loja {
	...
	public void atualizarProdutosFranquia(ClasseProduto produto) throws CodigoInexistenteException, NumeroLimiteExcedido, ProdutoJaCadastrado{	
			lojas.atualizarProduto(produto);
	}
